...
or line anchors. The configured model name is metadata for the runner; the
trusted publisher never exposes provider credentials or prompts in GitHub review
body output.
